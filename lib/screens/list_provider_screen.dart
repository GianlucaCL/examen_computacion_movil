...
class ListProviderScreen extends StatefulWidget {
  const ListProviderScreen({super.key});

  @override
  State<ListProviderScreen> createState() => _ListProviderScreenState();
}

class _ListProviderScreenState extends State<ListProviderScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
...
class _ProviderCard extends StatelessWidget {
  ...
  Future<void> _confirmDelete(BuildContext context, ProviderModel provider) async {
    ...
    if (confirm == true && context.mounted) {
      ...
      final success = await provider.deleteProvider(this.provider.id);
